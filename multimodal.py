...
def main(args):
    ...
    features_train, protein_train_embeddings = load_BERT_embedding(args.path_embeddings + '/train/embeddings.pkl')
    features_test, protein_test_embeddings = load_BERT_embedding(args.path_embeddings + '/test/embeddings.pkl')
    
    dataset_train = DGLGraphDataset_Multimodal(adj_train, features_train, edge_features_train, protein_train_embeddings, y_train)
    dataset_test = DGLGraphDataset_Multimodal(adj_test, features_test, edge_features_test, protein_test_embeddings, train=False)
